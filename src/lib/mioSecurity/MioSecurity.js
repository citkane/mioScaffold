/* Leave all of these here!!! needed for runChallenge. */
const {
    'node-rsa':NodeRSA,
    axios,
    'folder-hash':folder_hash,
    checksum, 'fs-extra':fs
} = require('@mio/mioscaffold');
const { hashElement } = folder_hash;
...
module.exports = class MioSecurity extends KeyGen {
    constructor(_appDetails, _logger) {
        super(_logger, _appDetails.domain,_appDetails.config)
